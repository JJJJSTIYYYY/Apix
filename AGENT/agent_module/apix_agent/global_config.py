...
BASE_DIR = os.environ.get("AGENT_BASE_DIR", "../apix_running_time/") # Download cache dir
...
AGENT_SERVICE_URL = os.environ.get("AGENT_SERVICE_URL", "http://localhost:5091")  # Apix service URL
